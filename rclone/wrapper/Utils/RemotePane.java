...
/**
 * Painel onde irá mostrar o Remoto ao usuario.
 * Ele herda de BorderPane, por causa de uma ideia futura.
 * @author neoold
 *
 */
public class RemotePane extends BorderPane {
	...
	/**
	 * Construtor carrega os icones, instancia as listas, organiza o container
	 * e configura o serviço do rclone.
	 * @param remote
	 */
			...
			public TreeCell<FileRemote> call(TreeView<FileRemote> view) {
				return new TreeCell<FileRemote>() {
					...
					protected void updateItem(FileRemote item, boolean empty) {
						...
						if (
								monoRcloneTask.isDirectoryActived() &&
	 ...
	 * FileRemote para TreeItem, esse metodo somente
	 * adiciona esse resultado na TreeView, entretando ele 
	 * tambem caça o diretorio para adicionar novos diretorios
	 * aninhados.
	...
	/**
	 * Esse metodo converte uma List<FileRemote> para
	 * List<TreeItem<FileRemote>>
	 * @param listA
	 * @return
	 */	
